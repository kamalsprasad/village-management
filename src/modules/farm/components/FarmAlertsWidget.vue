    ...
    <q-card-section>
      <div class="row items-center justify-between q-mb-sm">
        <div class="text-subtitle2 text-weight-medium">
          ...
          Farm Alerts
          <q-badge v-if="criticalCount" color="negative" class="q-ml-xs">{{ criticalCount }}</q-badge>
        </div>
        <q-btn
          flat
          dense
      ...
      <div v-if="isLoading" class="flex flex-center q-pa-md">
        <q-spinner color="orange" size="1.5em" />
      </div>
      ...
      <q-list v-else dense separator>
        ...
        >
          ...
          <q-item-section>
            <q-item-label class="text-caption ellipsis">{{ alert.title }}</q-item-label>
          </q-item-section>
          <q-item-section side>
            <q-badge
              :color="severityColor(alert.severity)"
